...
document.querySelectorAll('.mission-card, .activity-item, .gallery-item, .about-text, .about-image').forEach(el => {
    el.style.opacity = '0';
...
// Gestion du changement de thème (header transparent/opaque)
window.addEventListener('scroll', () => {
...
document.querySelectorAll('.mission-card, .gallery-item').forEach(card => {
...
console.log('🌱 Site CASOP chargé avec succès!');